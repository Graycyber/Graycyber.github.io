...
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221003032234.png)

- viewing the robots.txt file

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221003032811.png)

- i run a port scan `nmap -sV -sC -p- -T4 192.168.169.88`

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221003032858.png)
...
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012110100.png)

- then i further enumerate the wordpress site using wpscan`wpscan --url http://sunset-midnight/`

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221003041346.png)

- i also enumerated for possible users using `wpscan --url http://sunset-midnight/ -e u` and got admin

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221003041745.png)
...
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012110420.png)
...
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221011010441.png)

- then i can view the databases available and also the tables in the wordpress_db database

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221011010717.png)

- then i view the content of the wp_users table

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221011011804.png)
...
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221011014041.png)

- and i am able to log in with admin and 123456 as the password at http://sunset-midnight/admin
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221011014418.png)

#### Foothold
- now i tried editing the theme, so i can get a reverse shell but it didn't update for some reason

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221011015135.png)
...
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012092545.png)

- then looking through, i viewed the wordpress config file

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012093109.png)

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012093126.png)
...
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012093805.png)

- i found the first flag in the home directory

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012101309.png)

#### Privilege Escalation
- so searching for SUID files i discovered the status binary

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012104325.png)

- then running strings on this binary, i saw that it was using the service binary as well

![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012104731.png)
...
![](/assets/SunsetMidnight_assets/Pasted%20image%2020221012105351.png)
