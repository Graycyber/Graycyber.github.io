...
![](/assets/Sar_assets/Pasted%20image%2020220927204848.png)

- then i run a port scan on the target for open ports`nmap -sV -sC -p- -T4 192.168.70.35`

![](/assets/Sar_assets/Pasted%20image%2020220927205456.png)
...
![](/assets/Sar_assets/Pasted%20image%2020220927211435.png)
...
![](/assets/Sar_assets/Pasted%20image%2020220927212259.png)

![](/assets/Sar_assets/Pasted%20image%2020220927212409.png)

- `http://192.168.70.35/sar2HTML/index.php?plot=;cat /home/local.txt` and get the flag as 4cc5606165bee87839fc25783d42d552

![](/assets/Sar_assets/Pasted%20image%2020220927213917.png)
...
![](/assets/Sar_assets/Pasted%20image%2020220928213828.png)

- then i spawn a more interactive shell using python 

![](/assets/Sar_assets/Pasted%20image%2020220928213941.png)

- looking at the home directory we can also view the first flag as well

![](/assets/Sar_assets/Pasted%20image%2020220928214038.png)

#### Privilege Escalation
- so i retrieve the linpeas.sh script from my machine to find privilege escalation vectors

![](/assets/Sar_assets/Pasted%20image%2020220928214400.png)
...
![](/assets/Sar_assets/Pasted%20image%2020220929091928.png)

![](/assets/Sar_assets/Pasted%20image%2020220928214617.png)
...
![](/assets/Sar_assets/Pasted%20image%2020220929090218.png)
...
![](/assets/Sar_assets/Pasted%20image%2020220929081944.png)
