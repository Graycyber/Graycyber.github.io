...
![](Attacktivedirectory_assets/Pasted%20image%2020221017002351.png)
![](Attacktivedirectory_assets/Pasted%20image%2020221017002442.png)
...
![](Attacktivedirectory_assets/Pasted%20image%2020221017001631.png)
...
![](Attacktivedirectory_assets/Pasted%20image%2020221017001747.png)
- and then viewing the hashes, I can see that the user we can use is the `svc-admin` user
![](Attacktivedirectory_assets/Pasted%20image%2020221017003335.png)
...
![](Attacktivedirectory_assets/Pasted%20image%2020221017003033.png)
...
![](Attacktivedirectory_assets/Pasted%20image%2020221016214451.png)
- and after gaining access, I can see the first flag on the desktop as TryHackMe{K3rb3r0s_Pr3_4uth}
![](Attacktivedirectory_assets/Pasted%20image%2020221016214519.png)
#### Further Enumeration
...
![](Attacktivedirectory_assets/Pasted%20image%2020221016203834.png)
...
![](Attacktivedirectory_assets/Pasted%20image%2020221016213057.png)
- and viewing the file in the desktop, I get the second flag as TryHackMe{B4ckM3UpSc0tty!}
![](Attacktivedirectory_assets/Pasted%20image%2020221016213517.png)
#### Privilege Escalation
- looking at this, I can see that this account is a admin account in the domain
![](Attacktivedirectory_assets/Pasted%20image%2020221017002053.png)
...
![](Attacktivedirectory_assets/Pasted%20image%2020221016231126.png)
...
![](Attacktivedirectory_assets/Pasted%20image%2020221016233142.png)
- and then looking at the Desktop directory, I get the root flag as TryHackMe{4ctiveD1rectoryM4st3r}
![](Attacktivedirectory_assets/Pasted%20image%2020221016234531.png)
