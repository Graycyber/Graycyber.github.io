...
![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026172513.png)
...
![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026172547.png)

- going to the site, I see it contains a zip file

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026170010.png)

- then i cracked the zip using `fcrackzip -v -u -D -p /usr/share/wordlists/rockyou.txt save.zip` and got the password 

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026170059.png)

- then i opened the zip file

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026170333.png)

- viewing the file, i get the passwd file, shadow file and other files

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026170349.png)

- viewing the passwd file and I found a user

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026170508.png)

- then shadow file, and also fins the entry for that user

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026170541.png)

- i'll put both entries in different files

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026172322.png)
...
![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026172344.png)

- using john I crack the hash `john --wordlist=/usr/share/wordlists/rockyou.txt unshadow.txt` and get the password as `server`

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026172816.png)

- then logging in, I get foothold `ssh 296640a3b825115a47b68fc44501c828@192.168.53.85`

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026173033.png)

- so i realised i am in a restricted shell

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026181146.png)
...
![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026180708.png)
...
![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026181157.png)

- then i got the first flag

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026181320.png)

#### Privilege Escalation
- so now looking at the option 5 for that script, i see that i can run an Antivirus scan, do I run it

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026191542.png)

- then i run a pspy script to checking for running processes using `pspy64`

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026191608.png)
...
![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026191713.png)

- so I follow the steps for the exploit

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026192937.png)
...
![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026192702.png)

- then i escalate privileges and finally get root privileges

![](/assets/SunsetDecoy_assets/Pasted%20image%2020221026192800.png)
