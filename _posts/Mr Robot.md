...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022192447.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022194302.png)

- the key-1-of-3.txt file, I got the first key

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022194725.png)

- then viewing the other directory, I saw a list of words, so I save it in a file

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022195024.png)

- I did an nmap scan to discover the open ports and services `nmap -sV -sC -T4 -p- 10.10.245.237`

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022195143.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022204353.png)

- viewing the sitemap and sitemap.xml directories and it shows the error

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022200712.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022203907.png)

- looking at directories found, I viewed the readme but got nothing reasonable

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022204248.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022220831.png)

- then set the payload options as the list in the fsocity.dic file

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221025093827.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022220344.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221025094101.png)

- so i then try logging in with the Elliot but with an invalid password and got another error

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221025094252.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022204601.png)

- decoding the text i get the login credentials of the user elliot

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022205047.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022211142.png)

- logging in, I see the dashboard

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022215942.png)

- so I decided to upload a reverse shell script in a wordpress theme editor

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022213603.png)
...
![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022213531.png)

- then i got a more interactive `python3 -c 'import pty;pty.spawn("/bin/bash")'`

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022213745.png)

- I couldn't view the second key as the current user, but i found the credentials of the robot user with it hash

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022213837.png)

- so cracking the md5 hash, i got the robot user's password

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022214102.png)

- I was then able to switch to the robot user and view the password

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022225649.png)

- then I got linpeas to the tmp directory and ran it

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022214453.png)

- analysing the results of linpeas script and I saw nmap binary was running SUID permissions

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022215419.png)

- so from gtfobins i was able to get how to elevate privileges and then running it I got it

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022215519.png)

- I then found the third key in the root directory

![](/assets/Mr%20Robot_assets/Pasted%20image%2020221022215706.png)
