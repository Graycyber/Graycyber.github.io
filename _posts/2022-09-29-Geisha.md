...
![](/asset/Geisha_assets/Pasted%20image%2020220927164613.png)

- then i run a port scan using nmap `nmap -sV -sC -p- -T4 192.168.155.82`

![](/asset/Geisha_assets/Pasted%20image%2020220927185427.png)

- viewing the port 8088, i didn't find any relevant information and its just like the default page

![](/asset/Geisha_assets/Pasted%20image%2020220927164632.png)
...
![](/asset/Geisha_assets/Pasted%20image%2020220927171405.png)
...
![](/asset/Geisha_assets/Pasted%20image%2020220927164746.png)

- viewing the other directories i get

![](/asset/Geisha_assets/Pasted%20image%2020220927175715.png)
...
![](/asset/Geisha_assets/Pasted%20image%2020220927182705.png)
...
![](/asset/Geisha_assets/Pasted%20image%2020220927183546.png)
...
![](/asset/Geisha_assets/Pasted%20image%2020220927193620.png)

- then i save it in a file named id and run `ssh root@192.168.70.82 -i id` and finally get root access

![](/asset/Geisha_assets/Pasted%20image%2020220927193832.png)
