...
![](Agent%20Sudo_assets/Pasted%20image%2020221027094839.png)
- then i go ahead to scan for directories using `nmap -sV -sC -T4 -A -p- 10.10.47.253`
![](Agent%20Sudo_assets/Pasted%20image%2020221027100657.png)
...
![](Agent%20Sudo_assets/Pasted%20image%2020221027100729.png)
...
![](Agent%20Sudo_assets/Pasted%20image%2020221027105649.png)
- going there i discover another message, and i got the name of one of the agents as as Chris
![](Agent%20Sudo_assets/Pasted%20image%2020221027105958.png)
...
![](Agent%20Sudo_assets/Pasted%20image%2020221027111626.png)
- so logging in to the ftp server, i retrieved the files stored and viewed them
![](Agent%20Sudo_assets/Pasted%20image%2020221027112512.png)
- so viewing the message i was able to get another hint and 2 image files
![](Agent%20Sudo_assets/Pasted%20image%2020221027112831.png)
![](Agent%20Sudo_assets/Pasted%20image%2020221027112911.png)
![](Agent%20Sudo_assets/Pasted%20image%2020221027112935.png)
- I view the images using exiftool 
![](Agent%20Sudo_assets/Pasted%20image%2020221027113046.png)
![](Agent%20Sudo_assets/Pasted%20image%2020221027113109.png)
...
![](Agent%20Sudo_assets/Pasted%20image%2020221027113841.png)
- so i got a zip file after the extraction
![](Agent%20Sudo_assets/Pasted%20image%2020221027113945.png)
- i tried extracting it but it required a password
![](Agent%20Sudo_assets/Pasted%20image%2020221027114027.png)
...
![](Agent%20Sudo_assets/Pasted%20image%2020221027115834.png)
- i got the image file on my attack machine and did some reverse image search with google images
![](Agent%20Sudo_assets/Pasted%20image%2020221027120422.png)
![](Agent%20Sudo_assets/Pasted%20image%2020221027120434.png)
![](Agent%20Sudo_assets/Pasted%20image%2020221027120459.png)
- then i found a page and got the title of that page
![](Agent%20Sudo_assets/Pasted%20image%2020221027121217.png)
![](Agent%20Sudo_assets/Pasted%20image%2020221027121112.png)
...
![](Agent%20Sudo_assets/Pasted%20image%2020221027210846.png)
...
![](Agent%20Sudo_assets/Pasted%20image%2020221027205531.png)
- to answer the question of the CVE, i checked for the sudo version using `sudo -V | grep "Sudo ver"`
![](Agent%20Sudo_assets/Pasted%20image%2020221027220010.png)
...
![](Agent%20Sudo_assets/Pasted%20image%2020221027221006.png)
![](Agent%20Sudo_assets/Pasted%20image%2020221027221037.png)
- so running the command `sudo -u#-1 /bin/bash` and entered james password  and also got root access and the root flag as well
![](Agent%20Sudo_assets/Pasted%20image%2020221027220839.png)
![](Agent%20Sudo_assets/Pasted%20image%2020221027221128.png)
