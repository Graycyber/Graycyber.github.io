...
![](/assets/FunboxEasy_assets/Pasted%20image%2020221028181118.png)

- then i scan for open ports and services using nmap `nmap -sV -sC -T4 -A -p- 192.168.55.111`

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028194556.png)
...
![](/assets/FunboxEasy_assets/Pasted%20image%2020221028181202.png)

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028181330.png)

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028181341.png)

- in the store admin login, i tried logging in with admin and any password and i got authenticated

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028183637.png)

- then i was presented with the page which showed different boo

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028183737.png)

- I tried testing for SQL injection and saw that the application was vulnerable

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028184250.png)
...
![](/assets/FunboxEasy_assets/Pasted%20image%2020221028184912.png)
...
![](/assets/FunboxEasy_assets/Pasted%20image%2020221028185054.png)
...
![](/assets/FunboxEasy_assets/Pasted%20image%2020221028185146.png)
...
![](/assets/FunboxEasy_assets/Pasted%20image%2020221028185507.png)
...
![](/assets/FunboxEasy_assets/Pasted%20image%2020221028202318.png)

- then knowing the images arebeing stored in the bootstrap directory, i go to the my script

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028201206.png)

- after setting up my netcat listener, i then click on the script

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028202512.png)

- and then i get  a reverse shell

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028202645.png)

- viewing the current directory i discover the credentials for different accounts

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028202823.png)
...
![](/assets/FunboxEasy_assets/Pasted%20image%2020221028211216.png)

- i was also able to login using the ssh credentials found i.e tony as username and password as yxcvbnmYYY

![](/assets/FunboxEasy_assets/Pasted%20image%2020221028203036.png)
